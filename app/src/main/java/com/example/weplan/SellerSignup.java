...
public class SellerSignup extends AppCompatActivity {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            pDialog.setConfirmClickListener(new KAlertDialog.KAlertClickListener() {
                                ...
                                public void onClick(KAlertDialog sDialog) {
                                    Intent intent = new Intent(getApplication(), SellerDashboard.class);
    ...
    private void initializeUI() {
        emailTV = findViewById(R.id.seller_signup_email);
        passwordTV = findViewById(R.id.seller_signup_password);
        phoneTV=findViewById(R.id.seller_signup_phone);
        locationTV=findViewById(R.id.seller_signup_location);
        nameTV=findViewById(R.id.seller_signup_name);
